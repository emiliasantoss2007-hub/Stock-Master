...
2.2 Gestão de Estoque 14

2.3 Engenharia de Software 14

2.4 Banco de Dados 14

2.5 Segurança da Informação 14

**3 LEVANTAMENTO E ANÁLISE DE REQUISITOS** **15**

3.1 Visão Geral do Sistema 15

3.2 Escopo do Sistema 15

3.3 Perfis de Usuário 15

3.3.1 Administrador 15
...
3.6 Regras de Negócio 15

**4 MODELAGEM DO SISTEMA** **17**

4.1 Diagrama de Casos de Uso 17

4.2 Descrição dos Casos de Uso 17

4.3 Modelo Conceitual 17

4.4 DER - Diagrama Entidade Relacionamento 17

4.5 Dicionário de Dados 17

4.6 Modelo Lógico 17

4.7 Fluxo de Movimentação de Estoque 17

Entrada de Estoque 17

Saída de Estoque 17

Expurgo 17

4.8 Regras de Integridade 17

**5 PROPOSTA DA SOLUÇÃO** **19**

5.1 Arquitetura Geral do Sistema 19

5.2 Segurança 19

5.3 Controle de Estoque 19

5.4 Benefícios Esperados 19

**6 CONSIDERAÇÕES FINAIS** **20**

6.1 Retomada do Problema 20

6.2 Objetivos Alcançados 20

6.3 Resultados Esperados 20

6.4 Importância da Modelagem 20

6.5 Limitações do Trabalho 20

6.6 Trabalhos Futuros 20
...
APÊNDICE A - Requisitos Funcionais Completos 24

APÊNDICE B - Regras de Negócio Completas 24

APÊNDICE C - Casos de Uso Completos 24

**ANEXOS** **25**

ANEXO A - Diagrama de Casos de Uso 25

ANEXO B - DER Completo 25

ANEXO C - Diagrama de Classes 25

ANEXO D - Diagrama de Sequência 25

ANEXO E - Diagrama de Atividades 25

ANEXO F - Fluxogramas do Sistema 25
